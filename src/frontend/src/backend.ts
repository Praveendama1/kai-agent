...
export class Backend implements backendInterface {
    ...
    async addMessage(arg0: SessionId, arg1: Message): Promise<void> {
    ...
    async createSession(arg0: SessionId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllSessions(): Promise<Array<SessionId>> {
        if (this.processError) {
            try {
    ...
    async is2FAEnabled(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.is2FAEnabled();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async set2FAEnabled(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.set2FAEnabled(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
